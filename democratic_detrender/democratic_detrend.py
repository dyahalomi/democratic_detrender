...
def detrend_all(
    ...
    """
    Perform comprehensive detrending of stellar photometry data using multiple methods.
    ...
    ensemble_statistic : str, optional
        Statistic to use for ensemble combination. Default is 'median'.
    ...
    tuple
        A tuple containing:
        - pandas.DataFrame : Detrended light curve data
        - numpy.ndarray : Transit center times in the data
        - numpy.ndarray : Orbital period(s)
        - numpy.ndarray : Transit duration(s)
    """
