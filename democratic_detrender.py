...
parser.add_argument('-d', '--depth', default=0.01, help='Sets depth of detrended plots. Default is 0.02.')
...
if flux_type == 'both':
    ...
    plot_phase_fold_lc(x_detrended, method_marg_detrended, pdc_period, pdc_t0s, 20, figname = path + '/' + 'phase_folded.pdf')
...
# check if we should run just pdc
    ...
    # plot binned phase folded lightcurve
    plot_phase_fold_lc(x_detrended, method_marg_detrended, pdc_period, pdc_t0s, 20, figname = path + '/' + 'phase_folded_PDC.pdf')
...
# check if we should run just sap
    ...
    # plot binned phase folded lightcurve
    plot_phase_fold_lc(x_detrended, method_marg_detrended, sap_period, sap_t0s, 20, figname = path + '/' + 'phase_folded_SAP.pdf')
